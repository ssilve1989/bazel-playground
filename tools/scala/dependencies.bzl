...
def scala_dep(dep):
    """Returns the scala dep with the scala version suffixed"""
    return dep + "_2_13"
...
MAVEN_ARTIFACTS = [
    ...
    "com.thesamet.scalapb:compilerplugin_%s:%s" % (SCALA_VERSION, SCALAPB_VERSION),
    "com.thesamet.scalapb:lenses_%s:%s" % (SCALA_VERSION, SCALAPB_VERSION),
